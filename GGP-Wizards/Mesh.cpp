...
{
	init(vertices, vertex_count, indices, index_count, device);
}

Mesh* Mesh::init(Vertex* vertices, int vertex_count, unsigned int *indices, int index_count, ID3D11Device* device) {
